 ...
 * no matter how we divide it. since 5 - 2 = 3 > k, the condition is 
 * not satisfied and so there is no valid division.
 * 
 * Example 3:
...
public class DivideArrayIntoArraysWithMaxDifference {
	class Solution { // O(N * log(N)), O(1), N - nums.length
