 ...
 * 
 * You are given an integer n which represents an array nums containing 
 * the numbers from 1 to n in order. Additionally, you are given a 2D array 
 * conflictingPairs, where conflictingPairs[i] = [a, b] indicates that a and b 
 * form a conflicting pair.
 * 
 * Remove exactly one element from conflictingPairs. Afterward, count 
 * the number of non-empty subarrays of nums which do not contain both a and b 
 ...
 * [1], [2], [3], [4], [1, 2], [2, 3], [3, 4], [1, 2, 3] and [2, 3, 4].
 ...
 * Output: 12
 * Explanation:
 * Remove [1, 2] from conflictingPairs. Now, conflictingPairs = 
 * [[2, 5], [3, 5]].
...
public class MaximizeSubarraysAfterRemovingOneConflictingPair {
	class Solution { // O(N + M), O(N) where N = n, M = conflictingPairs.length
