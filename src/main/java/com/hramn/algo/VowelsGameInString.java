 ...
 * 
 * You are given a string s, Alice and Bob will take turns playing 
 * the following game where Alice starts first:
 ...
 * Alice plays third, she can delete the whole string s = "er" which contains 
 * 1 vowel.
