...
public class MaximumValueOfOrderedTripletITest {
	@Test
	@DisplayName("nums = [12,6,1,2,7] -> 77")
	void testBruteforceSolutionMaximumTripletValue1() {
		MaximumValueOfOrderedTripletI parent = new MaximumValueOfOrderedTripletI();
		MaximumValueOfOrderedTripletI.BruteforceSolution solution = parent.new BruteforceSolution();
	...
	void testBruteforceSolutionMaximumTripletValue2() {
		MaximumValueOfOrderedTripletI parent = new MaximumValueOfOrderedTripletI();
		MaximumValueOfOrderedTripletI.BruteforceSolution solution = parent.new BruteforceSolution();
	...
	void testBruteforceSolutionMaximumTripletValue3() {
		MaximumValueOfOrderedTripletI parent = new MaximumValueOfOrderedTripletI();
		MaximumValueOfOrderedTripletI.BruteforceSolution solution = parent.new BruteforceSolution();
	...
	void testSolutionMaximumTripletValue1() {
		MaximumValueOfOrderedTripletI parent = new MaximumValueOfOrderedTripletI();
		MaximumValueOfOrderedTripletI.Solution solution = parent.new Solution();
		long result = solution.maximumTripletValue(new int[] {12,6,1,2,7});
		assertEquals(77, result);
	}
